                                        ...
                                        <select name="id_siswa" id="Siswa" class="form-control">
                                            ...
                                            @foreach ($siswa as $item)
                                                <option value="{{ $item->id_siswa }}"
                                                    {{ $item->id_siswa == $penilaian->id_siswa ? 'selected' : '' }}>
                                                    {{ $item->nama_siswa }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="id_pelajaran" id="Pelajaran" class="form-control">
                                            ...
                                            @foreach ($mapel as $item)
                                                <option value="{{ $item->id_pelajaran }}"
                                                    {{ $item->id_pelajaran == $penilaian->id_pelajaran ? 'selected' : '' }}>
                                                    {{ $item->nama_mapel }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <select name="id_kategori_penilaian" id="Jenis" class="form-control">
                                            ...
                                            @foreach ($kategori as $item)
                                                <option value="{{ $item->id_kategori }}"
                                                    {{ $item->id_kategori == $penilaian->id_kategori_penilaian ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nilai') is-invalid @enderror"
                                            id="nilai" name="nilai" value="{{ old('nilai', $penilaian->nilai) }}"
                                            required>
                                        @error('nilai')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
