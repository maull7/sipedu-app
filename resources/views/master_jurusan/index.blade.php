    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Master Jurusan</h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($data as $i)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('master_jurusan.edit', $i->id_jurusan) }}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#deleteModal{{ $i->id_jurusan }}">
                                                    <i class="fas fa-trash-alt"></i>
                                                </button>
                                                <!-- Delete Modal -->
                                                <div class="modal fade" id="deleteModal{{ $i->id_jurusan }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form
                                                                    action="{{ route('master_jurusan.destroy', $i->id_jurusan) }}"
                ...
                <form action="{{ route('master_jurusan.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="thn">Jurusan</label>
                            <input type="text" id="thn" name="nama_jurusan" class="form-control" required>
                        </div>
