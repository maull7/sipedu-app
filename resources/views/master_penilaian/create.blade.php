                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_siswa" id="Siswa" class="form-control">
                                                        ...
                                                        @foreach ($siswa as $item)
                                                            <option value="{{ $item->id_siswa }}">{{ $item->nama_siswa }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error('id_siswa')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_pelajaran" id="Pelajaran" class="form-control">
                                                        ...
                                                        @foreach ($mapel as $item)
                                                            <option value="{{ $item->id_pelajaran }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_kategori_penilaian" id="Jenis"
                                                        class="form-control">
                                                        <option>Pilih Jenis Penilaian</option>
                                                        @foreach ($kategori as $item)
                                                            <option value="{{ $item->id_kategori }}">
                                                                {{ $item->kategori_penilaian }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_kategori_penilaian" id="Jenis2"
                                                        class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01"
                                                        class="form-control @error('nilai_formatif') is-invalid @enderror"
                                                        id="nilai_formatif" name="nilai_formatif" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01"
                                                        class="form-control @error('nilai_mental') is-invalid @enderror"
                                                        id="nilai_mental_input" name="nilai_mental" required>
                                                    @error('nilai_mental')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
...
@section('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Baca query param untuk memilih tab awal
